...
<body onload="window.print(); self.close();">
    <div align="center">
        <table width="500" border="0" cellpadding="1" cellspacing="0">
            <br>
            <tr>
                <th>Matahari Motor<br>
                Kec. Silat Hilir, Kabupaten Kapuas Hulu,<br>
                Kalimantan Barat 78656, Miau Merah</th>
            </tr>
            <tr align="center"><td><hr></td></tr>
            <tr>
                <td>#<?=$trx['nomor']?> | <?=date('d-m-Y H:i:s', strtotime($trx['tanggal_waktu']))?> <?=$trx['nama_kasir']?></td>
            </tr>
            <tr><td><hr></td></tr>
        </table>
